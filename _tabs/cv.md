...
<div style="border: 1px solid #666666ff; border-radius: 8px; padding: 15px; margin-bottom: 20px;">
  ...
  <!-- PhD -->
  <div class="mb-3">
    <strong>Doctor of Philosophy</strong> in Metallurgical and Materials Engineering [2022 – Present]  
    <br><small>Indian Institute of Technology Madras, Tamil Nadu, India | CGPA – 9.25/10</small>
  </div>
  <hr>
  <!-- MTech -->
  <div class="mb-3">
    <strong>Master of Technology</strong> in Metallurgical Engineering [2020 – 2022]  
    <br><small>Indian Institute of Technology Indore, Madhya Pradesh, India | CGPA – 9.39/10</small>
  </div>
  <hr>
  <!-- BTech -->
  <div class="mb-0">
    <strong>Bachelor of Technology</strong> in Mechanical Engineering [2012 – 2016]  
    <br><small>JNTUH College of Engineering Manthani, Telangana, India | Percentage – 68.86</small>
  </div>
</div>
...
<div style="border: 1px solid #666666ff; border-radius: 8px; padding: 15px; margin-bottom: 20px;">
  ...
  <div>
    <strong>Programming</strong>: MATLAB, Fortran, Julia, Python, Git, OpenMP, MPI, OpenACC
  </div>
  ...
  <div>
    <strong>CAE</strong>: Ansys, Abaqus, DAMASK, Gmsh, ParaView
  </div>
</div>
