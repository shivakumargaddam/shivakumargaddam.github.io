...
math: true
media_subpath: /assets/img/20260428/
image:
  path: cover.png
---
...
![Desktop View](image1.png){: width="972" height="589" #image1}
...
![Desktop View](image2.png){: width="972" height="589" .w-50 #faces}
...
![Desktop View](image3.png){: width="972" height="589" .w-50 #abaqus_pbc}
_**Figure 3:** node, edge and face numbering for ABAQUS implementation._

### **7.1 Sample input file for uniaxial strain along X-axis**
